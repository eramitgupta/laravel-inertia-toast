<template>
    ...
    >
        <div class="erag-toast-icon" v-html="currentIcon" />

        <div class="erag-toast-content" :class="{ 'erag-single-line': isSingleLine }">
            <strong>{{ title }}</strong>
            <span>{{ message }}</span>
        </div>

        <button type="button" class="erag-toast-close" @click.stop="closeToast">
