...
export const createToastState = (position: ToastPosition = DEFAULT_TOAST_POSITION): ToastState => ({
  toasts: [],
  position,
});
...
export const appendToastToState = (state: ToastState, toast: ToastItem): ToastState => ({
  position: toast.position ?? state.position,
  toasts: [...state.toasts, toast],
});

export const removeToastFromState = (state: ToastState, id: ToastId): ToastState => {
