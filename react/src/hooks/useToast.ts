...
const createToastMethod = (source: ToastApiSource, type: ToastType): ToastApiMethod => {
  return (message, title = TOAST_DEFAULT_TITLES[type], duration, position) => {
...
export const useToast = () => {
  ...
  const snapshot = useSyncExternalStore(subscribeToastStore, getToastSnapshot, getToastSnapshot);
